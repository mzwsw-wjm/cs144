...
static tuple<TCPConfig, FdAdapterConfig, bool, const char *> get_config(const span<char *> &args)
{
    TCPConfig c_fsm {};
...
int main(int argc, char **argv)
{
    try {
        ...
        LossyTCPOverIPv4MinnowSocket tcp_socket(LossyTCPOverIPv4OverTunFdAdapter(
