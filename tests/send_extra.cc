...
int main()
{
    try {
...

        {
            ...
            test.execute(ExpectMessage {}.with_payload_size(3).with_data("abc").with_seqno(isn + 1).with_fin(true));
            test.execute(Tick {rto - 1});
            test.execute(ExpectNoSegment {});
            test.execute(Tick {2});
            test.execute(ExpectMessage {}.with_payload_size(3).with_data("abc").with_seqno(isn + 1).with_fin(true));
...

        {
            ...
            test.execute(ExpectMessage {}.with_payload_size(1).with_data("a").with_seqno(isn + 1).with_no_flags());
            ...
            test.execute(ExpectMessage {}.with_payload_size(1).with_data("b").with_seqno(isn + 2).with_no_flags());
            ...
            test.execute(ExpectMessage {}.with_payload_size(1).with_data("c").with_seqno(isn + 3).with_no_flags());
            ...
            test.execute(ExpectMessage {}.with_payload_size(0).with_data("").with_seqno(isn + 4).with_fin(true));
...

        {
            ...
            test.execute(ExpectMessage {}.with_payload_size(2).with_data("bc").with_seqno(isn + 2).with_fin(true));
        }
