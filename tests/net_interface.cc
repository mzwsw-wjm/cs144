    ...
    try {
...

        {
            ...
            test.execute(ReceiveFrame {
                ...
                {}});
            test.execute(ExpectFrame {make_frame(
                local_eth, remote_eth, EthernetHeader::TYPE_ARP,
...

        {
            ...
            // first ARP mapping
            test.execute(ReceiveFrame {make_frame(remote_eth1, ETHERNET_BROADCAST, EthernetHeader::TYPE_ARP,
            ...
            // second ARP mapping
            test.execute(ReceiveFrame {make_frame(remote_eth2, ETHERNET_BROADCAST, EthernetHeader::TYPE_ARP,
