...
class Network
{
  private:
    ...
    static void exchange_frames(const string &x_name, AsyncNetworkInterface &x, const string &y_name,
    ...
    static void exchange_frames(const string &x_name, AsyncNetworkInterface &x, const string &y_name,
                                AsyncNetworkInterface &y, const string &z_name, AsyncNetworkInterface &z)
    {
    ...
    static void deliver(const string &src_name, AsyncNetworkInterface &src, const string &dst_name,
    ...
    static void deliver(const string &src_name, AsyncNetworkInterface &src, const string &dst1_name,
                        AsyncNetworkInterface &dst1, const string &dst2_name, AsyncNetworkInterface &dst2)
    {
        while (optional<EthernetFrame> frame = src.maybe_send()) {
  ...
  public:
    ...
    {
        exchange_frames("router.default", _router.interface(default_id), "default_router",
        ...
        exchange_frames("router.uun3", _router.interface(uun3_id), "dm42", host("dm42").interface(), "dm43",
                        host("dm43").interface());
    }
